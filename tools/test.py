...
checkpoint = '../model_files/checkpoint_ssd300.pth.tar'
...
# Load test data
test_dataset = TailorMachineDataset(data_folder,
                                split='train',
    ...
    with torch.no_grad():
        ...
        for i, (images, boxes, labels) in enumerate(tqdm(test_loader, desc='Evaluating')):
            ...
            det_boxes_batch, det_labels_batch, det_scores_batch = model.detect_objects(predicted_locs, predicted_scores,
                                                   ...
                                                   top_k=200)
            # Evaluation MUST be at min_score=0.01,
            # max_overlap=0.45, top_k=200 for fair comparision with
            # the paper's results and other repos
